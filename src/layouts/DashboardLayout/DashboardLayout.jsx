...
import { getAllUserDetail } from '@/redux/actions/userDetailsAction';
    ...
    return (
      <div className={classes.root + ' page-header__wrapper'}>
                  ...
                  <div className="fi-stack fi-stack--ver fi-stack--general">
                    ...
                    <Grid
                      ...
                      <Userprofile
                        ...
                        onLogoutClick={event => this.handleLogoutClick()}
                      />
                    </Grid>
                  </div>
                </div>
        ...
        <main
          ...
          <div
            className={
              classes.toolbar + ' fi-stack fi-stack--ver fi-stack--desktop'
            }
          />
          {this.props.children}
        </main>
...
const mapStateToProps = state => {
  return {
    UserProfileDetails: state.UserData.UserDataList,
    IsFailure: state.UserData.isFailure,
...
const mapDispatchToProps = dispatch => {
  return {
    loadUserData: bindActionCreators(getAllUserDetail, dispatch),
