...
// Actions
export const SetSelectedPracticeAction = getActionCreator(
      ...
      refreshDateData: [
        ...
        },
        {
          ...
          date:
            ...
            new Date(
              Number(response[2].data.getPracticeRefreshStatus[0].startdate),
            ),
          title:
        ...
        },
        {
          ...
          title:
            'End date of the duration against which the date was refreshed',
        },
      ],
    },
  };
      ...
      switch (type) {
        case PracticeListTypes.SUCCESS:
          const selectedPracticeId =
            payload.getPractices && payload.getPractices[0].id;
