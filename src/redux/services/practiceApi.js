...
export const getPractices = () => {
  ...
  return api.PegasusAPI(api.Resources.Practice, requestOption, response => {
    return response;
  });
};
...
export const getProviderCount = param => {
  ...
  return api.PegasusAPI(api.Resources.Provider, requestOption, response => {
    return response;
  });
};
...
export const getLocationCount = param => {
  ...
  return api.PegasusAPI(api.Resources.Location, requestOption, response => {
    return response;
  });
};
