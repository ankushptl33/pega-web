...
const Measure = props => {
  const pdfDownload = e => {
    window.open('/assets/pdf/template.pdf', '_blank');
  };
  ...
  return (
    <Grid container className="measure_wrapper">
      <Grid item className="measure_description__wrapper-main">
        <Grid item className="measure_description__wrapper"> {props.measure.displayname}</Grid>
        <Grid item>
          {(props.measure.measuredescription !== null && props.measure.measuredescription !== undefined)
