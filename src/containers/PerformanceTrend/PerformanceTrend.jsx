...
class PerformanceTrend extends React.Component {
          ...
          name:
            this.props.tabContentProps != undefined
              ...
              : this.props.displayname +
                ' ' +
                this.props.measure.measure.displayname,
        },
        layout: {
  ...
  render() {
    ...
    const layoutProps =
      this.props.tabContentProps != null
        ? this.props.tabContentProps.layout
        : layout;
    ...
    if (!this.state.isMounted) {
      return <Loader />;
    } else if (tableData.length == 0) return <h5>No records found. </h5>;
