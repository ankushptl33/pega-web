...
import ProgressBarContainer from '@/containers/PerformanceBar/PerformanceBar';
...
const mapStateToProps = state => ({
  ...
  SelectedDurationFlag:
    state.MeasureFilter.measureFilterData.selectedValues.durationFlag,
  SelectedDurationFrom:
    state.MeasureFilter.measureFilterData.selectedValues.durationFrom,
  SelectedDurationTo:
    state.MeasureFilter.measureFilterData.selectedValues.durationTo,
