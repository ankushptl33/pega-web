...
class Login extends Component {
  ...
  validateForm() {
    ...
    if (!this.state[this.props.passwordProps.name]) {
      formIsValid = false;
      errors[this.props.passwordProps.name] =
        this.props.passwordProps.name + ' is required';
    }
    ...
    if (!this.state[this.props.inputprops.Userid.name]) {
      ...
      typeof this.state[this.props.inputprops.Userid.name] !== 'undefined'
    ) {
      let regex = /^.{4,}$/;
      ...
      if (this.props.inputprops.Userid.validationType === 'EMAIL') {
        ...
        this.props.inputprops.Userid.validationType === 'ALPHANUMERIC'
      ) {
