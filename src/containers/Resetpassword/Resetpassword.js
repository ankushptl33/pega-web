      ...
      axios
        ...
        .then(res => {
          if (res.data.statusCode == 1) {
            ...
            this.setState({ error: res.data.description });
          }
        })
    ...
    if (verified === false) {
      return (
        <div>
          ...
          <Button href={'/forgotpassword'}>Click here</Button> to regenerate
        </div>
      );
    }
    return (
        ...
        <Grid item xs={12}>
          {this.state.isFormSubmit ? (
            ...
            <Resetpasswordform
              ...
              inputProps={{ value: this.state.password, custom: custom }}
            />
          )}
        </Grid>
      </Grid>
...
Resetpassword.defaultProps = {
  ...
  inputProps: {
    value: '',
    custom: [
      { regex: /^.{8,}$/, Message: 'Must be at least 8 characters in length' },
    ],
  },
};
