...
import { PRACTICE, PROVIDER, UNDEFINED } from '@/helper/constants';
import {
...
} from '@/redux/modules/providerDashboard';
...
class CliniciansPerformance extends Component {
  ...
  render() {
    ...
    if (this.props.Favoritefilter) {
      clinicianMeasureData = clinicianMeasureData.filter(
    ...
    if (
      ...
      this.props.ProviderMeasureList.length > 0
    ) {
